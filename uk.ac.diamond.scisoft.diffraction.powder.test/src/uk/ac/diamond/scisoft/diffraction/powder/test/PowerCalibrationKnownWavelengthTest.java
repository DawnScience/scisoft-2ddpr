...
public class PowerCalibrationKnownWavelengthTest {
	...
	public void CeO212kevPilatus170(){
		...
		try {
			AbstractDataset image = (AbstractDataset)LoaderFactory.getDataSet("/dls/science/groups/das/ExampleData/i04/CeO2/ceo2_12kev_170.cbf","image-01",null);
	...
	public void CeO212kevPilatus370(){
		...
		try {
			AbstractDataset image = (AbstractDataset)LoaderFactory.getDataSet("/dls/science/groups/das/ExampleData/i04/CeO2/ceo2_12kev_370.cbf","image-01",null);
			CalibrationStandards standards = CalibrationFactory.getCalibrationStandards();
			CalibrantSpacing ceO2 = standards.getCalibrationPeakMap("CeO2");
			CalibrationOutput result = PowderCalibration.calibrateKnownWavelength(image, 0.97949, 0.172, ceO2.getHKLs());
	...
	public void CeO216kevPilatus170(){
		...
		try {
			AbstractDataset image = (AbstractDataset)LoaderFactory.getDataSet("/dls/science/groups/das/ExampleData/i04/CeO2/ceo2_16kev_170.cbf","image-01",null);
			CalibrationStandards standards = CalibrationFactory.getCalibrationStandards();
			CalibrantSpacing ceO2 = standards.getCalibrationPeakMap("CeO2");
	...
	public void CeO216kevPilatus370(){
		...
		try {
			AbstractDataset image = (AbstractDataset)LoaderFactory.getDataSet("/dls/science/groups/das/ExampleData/i04/CeO2/ceo2_16kev_370.cbf","image-01",null);
			CalibrationStandards standards = CalibrationFactory.getCalibrationStandards();
			CalibrantSpacing ceO2 = standards.getCalibrationPeakMap("CeO2");
			CalibrationOutput result = PowderCalibration.calibrateKnownWavelength(image, 0.7749, 0.172, ceO2.getHKLs());
	...
	public void CeO229kevPerkin259(){
		//TODO needs ring rejection from fit to work
		try {
			AbstractDataset image = (AbstractDataset)LoaderFactory.getDataSet("/dls/science/groups/das/ExampleData/i15/I15_Detector_Calibration/PE_Data/29p2keV/CeO2_29p2keV_d259-00017.tif","image-01",null);
			CalibrationStandards standards = CalibrationFactory.getCalibrationStandards();
	...
	public void CeO229kevPerkin659(){
		//TODO needs ring rejection from fit to work
		try {
			AbstractDataset image = (AbstractDataset)LoaderFactory.getDataSet("/dls/science/groups/das/ExampleData/i15/I15_Detector_Calibration/PE_Data/29p2keV/CeO2_29p2keV_d659-00013.tif","image-01",null);
			CalibrationStandards standards = CalibrationFactory.getCalibrationStandards();
			CalibrantSpacing ceO2 = standards.getCalibrationPeakMap("CeO2");
			CalibrationOutput result = PowderCalibration.calibrateKnownWavelength(image, 0.425, 0.2, ceO2.getHKLs());
...
//	}
	...
	@Test
	public void LaB6329kevPerkin259(){
		//TODO needs ring rejection from fit to work
		try {
			AbstractDataset image = (AbstractDataset)LoaderFactory.getDataSet("/dls/science/groups/das/ExampleData/i15/I15_Detector_Calibration/PE_Data/29p2keV/LaB6_29p2keV_d359-00021.tif","image-01",null);
			CalibrationStandards standards = CalibrationFactory.getCalibrationStandards();
			CalibrantSpacing std = standards.getCalibrationPeakMap("LaB6");
			CalibrationOutput result = PowderCalibration.calibrateKnownWavelength(image, 0.425, 0.2, std.getHKLs());
			
			Assert.assertEquals(390, result.getDistance().getDouble(0), 0.9);
	...
	@Test
	public void LaB6229kevPerkin659(){
		try {
			AbstractDataset image = (AbstractDataset)LoaderFactory.getDataSet("/dls/science/groups/das/ExampleData/i15/I15_Detector_Calibration/PE_Data/29p2keV/LaB6_29p2keV_d659-00024.tif","image-01",null);
			CalibrationStandards standards = CalibrationFactory.getCalibrationStandards();
			CalibrantSpacing std = standards.getCalibrationPeakMap("LaB6");
			CalibrationOutput result = PowderCalibration.calibrateKnownWavelength(image, 0.425, 0.2, std.getHKLs());
	...
	public void CeO2Pixium788(){
		//TODO needs ring rejection from fit to work
		try {
			AbstractDataset image = (AbstractDataset)LoaderFactory.getDataSet("/dls/science/groups/das/ExampleData/powder/ceopowder.tiff","image-01",null);
			CalibrationStandards standards = CalibrationFactory.getCalibrationStandards();
			CalibrantSpacing ceO2 = standards.getCalibrationPeakMap("CeO2");
	...
	public void CeO2Pixium289(){
		//TODO needs ring rejection from fit to work
		try {
			AbstractDataset image = (AbstractDataset)LoaderFactory.getDataSet("/dls/science/groups/das/ExampleData/i12/AlgorithmTesting/Circular1/pixi_00000.tif","image-01",null);
			CalibrationStandards standards = CalibrationFactory.getCalibrationStandards();
			CalibrantSpacing ceO2 = standards.getCalibrationPeakMap("CeO2Minimal");
			CalibrationOutput result = PowderCalibration.calibrateKnownWavelength(image, 0.425, 0.2, ceO2.getHKLs());
	...
	public void CeO2Pixium689(){
		//TODO needs ring rejection from fit to work
		try {
			AbstractDataset image = (AbstractDataset)LoaderFactory.getDataSet("/dls/science/groups/das/ExampleData/i12/AlgorithmTesting/Circular1/pixi_00004.tif","image-01",null);
			CalibrationStandards standards = CalibrationFactory.getCalibrationStandards();
			CalibrantSpacing ceO2 = standards.getCalibrationPeakMap("CeO2");
			CalibrationOutput result = PowderCalibration.calibrateKnownWavelength(image, 0.425, 0.2, ceO2.getHKLs());
